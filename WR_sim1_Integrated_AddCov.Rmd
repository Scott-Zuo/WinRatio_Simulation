      ...
      if (df_comb_1col[i,1] > df_comb_1col[j,1]){
        g_hfunc_DR1[i, j] = (0.5) * (
          (df_comb_1col[i, "treatment"] * (1 - df_comb_1col[j, "treatment"]) * 1 /
            ...
            (
              cond_prob[i, 2] * cond_prob[j, 1] +
                cond_prob[i, 3] * cond_prob[j, 1] +
                cond_prob[i, 3] * cond_prob[j, 2]
            ) + 0 -
            (df_comb_1col[j, "treatment"] * (1 - df_comb_1col[i, "treatment"]) /
               (pi_func[j] * (1 - pi_func[i])) - 1) *
            (
              cond_prob[j, 2] * cond_prob[i, 1] +
                cond_prob[j, 3] * cond_prob[i, 1] +
                cond_prob[j, 3] * cond_prob[i, 2]
            )
        )
        ...
        g_hfunc_DR2[i, j] = (0.5) * (
          0 -
            (df_comb_1col[i, "treatment"] * (1 - df_comb_1col[j, "treatment"]) /
               (pi_func[i] * (1 - pi_func[j])) - 1) *
            (
              cond_prob[i, 1] * cond_prob[j, 2] +
                cond_prob[i, 1] * cond_prob[j, 3] +
                cond_prob[i, 2] * cond_prob[j, 3]
            ) +
            (df_comb_1col[j, "treatment"] * (1 - df_comb_1col[i, "treatment"]) *
            ...
            (df_comb_1col[j, "treatment"] * (1 - df_comb_1col[i, "treatment"]) /
               (pi_func[j] * (1 - pi_func[i])) - 1) *
            (
              cond_prob[j, 1] * cond_prob[i, 2] +
                cond_prob[j, 1] * cond_prob[i, 3] +
                cond_prob[j, 2] * cond_prob[i, 3]
            )
        )
      }
      else if (df_comb_1col[i,1] < df_comb_1col[j,1]){
