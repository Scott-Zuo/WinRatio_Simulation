...
sim_df$samplesize <- c(c(1:re_count)*10, c(1:re_count)*10)
...
var_plot <- ggplot(sim_df, aes(x=samplesize, y = variance,
  ...
  scale_x_continuous(breaks=seq(0,10*re_count,10)) + 
  theme(
...
re_df$samplesize <- c(1:re_count)*10
